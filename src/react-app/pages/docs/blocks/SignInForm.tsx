export default function SignInFormBlock() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-semibold tracking-tight mb-2">Sign in form</h1>
        <p className="text-lg text-muted-foreground">
          A simple sign in form with email and password fields.
        </p>
      </div>
