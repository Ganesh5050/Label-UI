export default function NavigationMenuDoc() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-semibold tracking-tight mb-2">Navigation Menu</h1>
        ...
        <div className="rounded-lg border border-border bg-card overflow-hidden">
          ...
          <div className="p-4">
            <pre className="text-sm">
              <code className="text-primary">npx @react-native-reusables/cli@latest add navigation-menu</code>
            </pre>
          </div>
        </div>
      </div>
