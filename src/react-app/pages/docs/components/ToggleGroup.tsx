import { ToggleGroup, ToggleGroupItem } from '@/react-app/components/ui/toggle-group';
...
export default function ToggleGroupDoc() {
  const basicUsageCode = `import { Bold, Italic, Underline } from 'lucide-react';
...
export default function Screen() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-4xl font-semibold tracking-tight mb-2">Toggle Group</h1>
      ...
      <div className="flex gap-2">
        ...
        <a
          href="https://www.radix-ui.com/docs/primitives/components/toggle-group#api-reference"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1 text-sm px-3 py-1.5 rounded-md border border-border hover:bg-accent"
        >
      ...
      <div className="space-y-4">
        ...
        <CodeBlock 
          code="npx @react-native-reusables/cli@latest add toggle-group" 
          language="bash"
          title="CLI"
        />
      </div>
  ...
  <ToggleGroupItem value="underline" aria-label="Toggle underline">
    <Underline className="h-4 w-4" />
        ...
        <h3 className="text-xl font-semibold tracking-tight">Single</h3>
        <ComponentPreview
          preview={<ToggleGroupSingle />}
